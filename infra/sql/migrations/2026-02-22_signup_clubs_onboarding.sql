-- Rider/Club onboarding + verification + membership migration.
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_users_rider_member_code_unique ON users (rider_member_code) WHERE rider_member_code IS NOT NULL;
CREATE UNIQUE INDEX IF NOT EXISTS idx_users_club_member_code_unique ON users (club_member_code) WHERE club_member_code IS NOT NULL;
